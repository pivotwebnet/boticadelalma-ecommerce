...
export const PRODUCTS: Product[] = [
  // Collares
  { id: 'p01', cat: 'collares', name: 'Colgante Luna Creciente',   price: 18500, was: 24000, tone: 'stone',  label: 'colgante · plata',    tags: ['plata 925', 'hecho a mano', 'intuición'], rating: 4.8, reviews: 124, new: false },
  { id: 'p02', cat: 'collares', name: 'Collar Raíz de Árbol',      price: 22800,             tone: 'moss',   label: 'collar · bronce',     tags: ['bronce', 'cordón', 'anclaje'],            rating: 4.9, reviews: 87,  new: true  },
  ...
  { id: 'p06', cat: 'cristales',name: 'Cuarzo Blanco Pulido',      price: 6400,              tone: 'cream',  label: 'cristal · pulido',    tags: ['claridad', 'limpieza'],                   rating: 4.8, reviews: 178           },
  { id: 'p07', cat: 'cristales',name: 'Set Chakras 7 Piedras',     price: 24900, was: 29500, tone: 'sage',   label: 'set · 7 piezas',      tags: ['chakras', 'set', 'anclaje'],              rating: 5.0, reviews: 91            },
  { id: 'p08', cat: 'cristales',name: 'Obsidiana Negra Pulida',    price: 7900,              tone: 'stone',  label: 'cristal · pulido',    tags: ['obsidiana', 'protección', 'anclaje'],     rating: 4.7, reviews: 142           },
  { id: 'p09', cat: 'cristales',name: 'Citrino Natural',           price: 8900,              tone: 'ember',  label: 'cristal',             tags: ['abundancia'],                             rating: 4.8, reviews: 67            },
  // Inciensos
  { id: 'p10', cat: 'inciensos',name: 'Palo Santo — 5 varas',      price: 4800,              tone: 'clay',   label: 'sahumerio',           tags: ['palo santo', 'Perú', 'limpieza'],         rating: 4.9, reviews: 421           },
  { id: 'p11', cat: 'inciensos',name: 'Salvia Blanca Atado',       price: 6500,              tone: 'sage',   label: 'sahumerio',           tags: ['salvia', 'limpieza', 'protección'],       rating: 4.9, reviews: 356, new: true  },
  { id: 'p12', cat: 'inciensos',name: 'Inciensos Nag Champa x12',  price: 3200,              tone: 'ember',  label: 'incienso · caja',     tags: ['India', 'amor'],                          rating: 4.7, reviews: 289           },
  { id: 'p13', cat: 'inciensos',name: 'Resina Mirra 30g',          price: 5400,              tone: 'ember',  label: 'resina',              tags: ['mirra', 'meditación', 'abundancia'],      rating: 4.8, reviews: 74            },
  // Velas
  ...
  { id: 'p15', cat: 'velas',    name: 'Vela Miel & Canela',        price: 4200,              tone: 'clay',   label: 'vela aromática',      tags: ['miel', 'amor'],                           rating: 4.9, reviews: 112           },
  ...
  // Tarot
  { id: 'p17', cat: 'tarot',    name: 'Tarot Rider-Waite Clásico',price: 18900,             tone: 'cream',  label: 'baraja · 78 cartas',  tags: ['principiantes', 'intuición'],             rating: 4.9, reviews: 512           },
  ...
  { id: 'p19', cat: 'tarot',    name: 'Mantel de Tarot Bordado',   price: 9500,              tone: 'moss',   label: 'mantel 55x55cm',      tags: ['accesorio', 'amor'],                      rating: 4.7, reviews: 62            },
  // Accesorios
  { id: 'p20', cat: 'accesorios',name: 'Porta Sahumerios Cerámica',price: 6800,              tone: 'clay',   label: 'cerámica',            tags: ['hecho a mano', 'anclaje'],                rating: 4.8, reviews: 89            },
  { id: 'p21', cat: 'accesorios',name: 'Campana Tibetana Mini',    price: 14500,             tone: 'ember',  label: 'bronce',              tags: ['sonido', 'meditación', 'anclaje'],        rating: 4.9, reviews: 54,  new: true  },
  { id: 'p22', cat: 'accesorios',name: 'Cuenco de Cuarzo 8"',      price: 32900,             tone: 'cream',  label: 'cuenco sonoro',       tags: ['sonoterapia', 'abundancia'],              rating: 5.0, reviews: 38            },
  { id: 'p23', cat: 'accesorios',name: 'Bolsita Ritual Lino',      price: 2900,              tone: 'sage',   label: 'accesorio',           tags: ['lino natural', 'protección'],             rating: 4.6, reviews: 127           },
];
